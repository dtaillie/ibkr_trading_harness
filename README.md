...
contract audit, Python compile, dashboard JavaScript syntax, pytest,
default/empty/seeded dashboard smokes, and accessibility smoke. Add
`--include-screenshots` for the slower dashboard layout screenshot checks.
