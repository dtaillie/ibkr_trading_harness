...
def test_cloud_status_server_receives_and_serves_status(tmp_path):
    ...
    try:
        ...
        assert "data-preview-summary" in html
        assert "data-preview-wall" in html
        ...
        assert "help-tour-title" in html
        assert "help-tour-note" in html
        assert "help-tour-cards" in html
        assert "help-tour-actions" in html
        ...
        assert "data-compare-action-note" in html
        assert "data-compare-action-cards" in html
        assert "data-compare-action-actions" in html
        ...
        assert "fetch-action-note" in html
        assert "fetch-action-cards" in html
        assert "fetch-action-actions" in html
        ...
        assert "page-intro-toggle" in html
        ...
        assert "performance-rollup-continuity-note" in html
        assert "performance-rollup-continuity-cards" in html
        assert "performance-rollup-continuity-body" in html
        assert "performance-rollup-continuity-actions" in html
        ...
        assert "operations-action-note" in html
        assert "operations-action-cards" in html
        assert "operations-action-actions" in html
        ...
        assert "runs-action-note" in html
        assert "runs-action-cards" in html
        assert "runs-action-actions" in html
        ...
        assert "check-dashboard-data-apis" in html
...
def test_cloud_status_server_serves_workbench_diagnostics(tmp_path):
    ...
    for name in (
        ...
        "app/30_runtime_core.js",
        "app/31_performance_math.js",
        "app/32_overview.js",
        "app/33_performance_views.js",
        "app/34_charts.js",
        "app/40_data_catalog.js",
        "app/41_data_explorer.js",
        "app/42_data_symbols.js",
        "app/43_data_detail_compare.js",
        "app/50_fetch.js",
