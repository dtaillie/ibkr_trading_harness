...
(() => {
  ...
  const selectors = [
    ...
    "#performance-review-cards strong",
    "#performance-review-cards small",
    "#performance-review-actions a",
    ...
    ".data-inventory-main span",
    ".data-inventory-cards strong",
    ".data-inventory-cards small",
    "#data-inventory-actions a",
    "#data-history-cards strong",
    "#data-history-cards small",
    "#data-history-actions a",
    ...
    "#workbench-readiness-cards strong",
    "#workbench-readiness-cards small",
    "#workbench-readiness-actions a",
    ".runs-review-main strong",
    ".runs-review-main span",
    ".runs-review-cards strong",
    ".runs-review-cards small",
    "#runs-review-actions a",
    ".runs-workflow-grid strong",
    ".runs-workflow-grid small",
    ".operations-readiness-main strong",
    ".operations-readiness-main span",
    ".operations-readiness-cards strong",
    ".operations-readiness-cards small",
...
(() => {
  ...
  const requirements = {
    ...
    "performance": [
      ...
      { selector: "#performance-review-note" },
    ...
    "data": [
      { selector: "#data-inventory-title" },
      { selector: "#data-history-note" },
    ...
    "workbench": [
      ...
      { selector: "#workbench-readiness-note" },
    ...
    "operations": [
      ...
      { selector: "#operations-readiness-title" },
