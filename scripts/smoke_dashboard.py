...
def run_smoke(
    *,
    ...
    try:
        ...
        if options.get("config_schema_version") != 1 or options.get("form_schema_version") != 3 or options.get("guide_schema_version") != 1:
        ...
        if snapshot.get("config_schema_version") != 1 or snapshot.get("form_schema_version") != 3 or snapshot.get("guide_schema_version") != 1:
