...
def run_smoke(
    *,
    ...
    try:
        ...
        for field_id in ("config-name", "config-plugin", "config-mode", "config-dataset", "config-risk-preset", "config-plugin-field-sma-crossover-fast", "config-allow-quality-warnings"):
